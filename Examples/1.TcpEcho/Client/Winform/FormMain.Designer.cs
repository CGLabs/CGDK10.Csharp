namespace Sample.TcpEcho.Client.Winform
{
	partial class Form_main
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_GROUP_RequestSend = new System.Windows.Forms.GroupBox();
			this.m_BUTTON_send = new System.Windows.Forms.Button();
			this.m_CHECK_RequestSend_start_stop = new System.Windows.Forms.CheckBox();
			...
			this.m_TEXT_RequestSend_times = new System.Windows.Forms.Label();
			...
			this.m_GROUP_RequestSend.SuspendLayout();
			this.SuspendLayout();
			// 
			// m_EDIT_Port
			// 
			...
			this.m_GROUP_traffic_info.Controls.Add(this.m_GROUP_RequestSend);
			...
			// m_GROUP_RequestSend
			// 
			this.m_GROUP_RequestSend.BackgroundImageLayout = System.Windows.Forms.ImageLayout.None;
			this.m_GROUP_RequestSend.Controls.Add(this.m_BUTTON_send);
			this.m_GROUP_RequestSend.Controls.Add(this.m_CHECK_RequestSend_start_stop);
			this.m_GROUP_RequestSend.Controls.Add(this.m_COMBO_send_test_message_size);
			this.m_GROUP_RequestSend.Controls.Add(this.m_TEXT_error_send_zero);
			this.m_GROUP_RequestSend.Controls.Add(this.m_TEXT_single_send);
			this.m_GROUP_RequestSend.Controls.Add(this.m_BUTTON_error_send_zero);
			this.m_GROUP_RequestSend.Controls.Add(this.m_BUTTON_single_send);
			this.m_GROUP_RequestSend.Controls.Add(this.m_TEXT_send_message_size);
			this.m_GROUP_RequestSend.Controls.Add(this.m_TEXT_RequestSend_times);
			this.m_GROUP_RequestSend.Controls.Add(this.m_EDIT_send_test_times);
			this.m_GROUP_RequestSend.Controls.Add(this.m_TEXT_explanation_2);
			this.m_GROUP_RequestSend.Location = new System.Drawing.Point(8, 129);
			this.m_GROUP_RequestSend.Name = "m_GROUP_RequestSend";
			this.m_GROUP_RequestSend.Size = new System.Drawing.Size(594, 97);
			this.m_GROUP_RequestSend.TabIndex = 5;
			this.m_GROUP_RequestSend.TabStop = false;
			this.m_GROUP_RequestSend.Text = "Send Test";
			// 
			// m_BUTTON_send
			// 
			...
			// 
			// m_CHECK_RequestSend_start_stop
			// 
			this.m_CHECK_RequestSend_start_stop.Appearance = System.Windows.Forms.Appearance.Button;
			this.m_CHECK_RequestSend_start_stop.Location = new System.Drawing.Point(237, 62);
			this.m_CHECK_RequestSend_start_stop.Name = "m_CHECK_RequestSend_start_stop";
			this.m_CHECK_RequestSend_start_stop.Size = new System.Drawing.Size(66, 24);
			this.m_CHECK_RequestSend_start_stop.TabIndex = 0;
			this.m_CHECK_RequestSend_start_stop.Text = "Start/Stop";
			this.m_CHECK_RequestSend_start_stop.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
			this.m_CHECK_RequestSend_start_stop.CheckedChanged += new System.EventHandler(this.on_CHECK_RequestSend_start_stop_checked_changed);
			// 
			...
			// 
			// m_TEXT_RequestSend_times
			// 
			this.m_TEXT_RequestSend_times.AutoSize = true;
			this.m_TEXT_RequestSend_times.Location = new System.Drawing.Point(92, 48);
			this.m_TEXT_RequestSend_times.Name = "m_TEXT_RequestSend_times";
			this.m_TEXT_RequestSend_times.Size = new System.Drawing.Size(34, 13);
			this.m_TEXT_RequestSend_times.TabIndex = 50;
			this.m_TEXT_RequestSend_times.Text = "Times";
			// 
			...
			this.m_GROUP_RequestSend.ResumeLayout(false);
			this.m_GROUP_RequestSend.PerformLayout();
		...
		private System.Windows.Forms.GroupBox m_GROUP_RequestSend;
		...
		private System.Windows.Forms.Label m_TEXT_RequestSend_times;
		...
		private System.Windows.Forms.CheckBox m_CHECK_RequestSend_start_stop;
