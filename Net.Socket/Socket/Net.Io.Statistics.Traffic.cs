...
namespace CGDK.Net.Io.Statistics
{
	...
	// implementation) 
		...
		public void				StatisticsOnDisconnect()					{ m_tick_disconnect=Environment.TickCount; m_count_connect_try=0;}
		public void				statistics_set_error_disconnect()			{ Interlocked.Exchange(ref m_is_error_disconnect, 1);}
		public void				statistics_check_error_disconnect()			{ long count_error_disconnect = Interlocked.Exchange(ref m_is_error_disconnect, 0); Nconnective.total.StatisticsOnErrorDisconnect(count_error_disconnect);}
