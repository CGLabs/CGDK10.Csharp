...
namespace TutorialGroupServer
{
	class Program
	{
		static public GroupArray pgroup_a = new();
		static public GroupArraySender pgroup_b = new();
		static public GroupList pgroup_c = new();
		static public GroupListSender pgroup_d = new();
